...
void gameorcred (void )
{
    ...
    printf("\n\nWELCOME\n");
    printf("\n\t1 - To Start Game\n\t2 - To see credits and start game\n\n\tSelect your option: " );
    scanf("%d",&opt);
    if(opt==1)
    {
        difficulty();
    ...
    {
        printf("\n________________________________________________________________________________________________________________________________________________________________________");
        printf("\nThis is not just a game that our team has crafted. \nThis is an unforgettable opportunity and an obligated responsibility that we carried everyday to make it a better experience for the user.\n");
        printf("We thank our professor Mrs M Swarna, Ph.D, M.Tech. for her untiring support from the day she taught us from the most fundamental chapters to the most complex topics. \nHer constant efforts to make us better at what we do, have made us what we are.\n");
        printf("MINESWEEPER is inspired from the classic Microsoft MINESWEEPER and is entirely made by the sheer hard work of out team.");
        printf("\n\nCREDITS\n");
        printf("\n\t1 - Mrs M Swarna    - Professor and Guide\n\t2 - Ms D Vanitha    - 20331A1223\n\t3 - Mr I Sunil      - 20331A1241\n\t4 - Mr K S S Surya  - 20331A1253 ");
        difficulty();
...
void print_minefield(void)                                  // This function prints the minefield
{
    ...
    printf("\n\n\nRULES\n");
    printf("\n\t1 - This is your minefield. Enter the horizontal 'x' and vertical 'y' value to check a tile in the minefield. \n\t2 - A 'B' on the tile indicates it is bland and it exposes other blank tiles surrounding it. \n\t3 - A numeric character on the tile indicates the number of mines or bombs surrounding the selected tile. \n\t4 - Stay away from the bombs and sweep your way through the entire minefield to stand out and be the best MINESWEEPER.\n\n\n");
...
void guess( void )
{
    ...
    scanf("%d %d", &x, &y);
    printf("\n\n");                              // Reading in the co-ordinates for the guess
    FLUSH;
    if( (x >= M) || (x < 0) || (y < 0) || (y >= N) )
    {
